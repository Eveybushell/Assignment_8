...
## Error Analysis
The model had a harder time identifying negative reviews. Looking at the two samples it pulled, it appears to be because people can find something they can enjoy in an otherwise disliked film. Whether this is returning to a once-loved film to find it aging poorly or a movie that is so-bad-it's-good in its cheesiness, there tends to be a lot of  